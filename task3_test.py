...
print('#' * 80)
print("\n")
print("Aliaksandr Martsinkevich | 2022-10-21 | Stage 2 | Task 3 | Selenium")
print("\n")
print('#' * 80)
print("\n")
...
class TestInstallment:
    try:
        ...
        value_of_starting_url = driver.current_url
        def test_value_of_starting_url(self):
            assert self.value_of_starting_url in url
        ...
        value_of_details_button = installment_buttons[0].find_element(By.CLASS_NAME, "button-label").get_attribute("innerHTML")
        def test_value_of_details_button(self):
            assert self.value_of_details_button == "Подробнее"
        ...
        value_of_random_phone_url = driver.current_url
        def test_value_of_random_phone_url(self):
            assert "/shop/phones/" in self.value_of_random_phone_url
        ...
        value_of_installment_duration = plan_selector.get_attribute("innerHTML").strip().replace("&nbsp;", " ")
        print("-" * 80)
        ...
        def test_value_of_installment_duaration(self):
            assert "6 мес" in self.value_of_installment_duration
        ...
        value_of_shopping_cart_url = driver.current_url
        def test_value_of_shopping_cart_url(self):
            assert "/asmp/" in self.value_of_shopping_cart_url
